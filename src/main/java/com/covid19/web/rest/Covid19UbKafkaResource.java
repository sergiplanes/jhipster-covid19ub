...
@RestController
@RequestMapping("/api/covid-19-ub-kafka")
public class Covid19UbKafkaResource {
    private final Logger log = LoggerFactory.getLogger(Covid19UbKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Covid19UbKafkaResource(KafkaProperties kafkaProperties) {
